...
export const DATA = {
  ...
  monthly_audios: {
    '2025-01': { pedro: 9, laura: 13 },
    '2025-02': { pedro: 6, laura: 15 },
    '2025-03': { pedro: 10, laura: 15 },
    '2025-04': { pedro: 7, laura: 19 },
    '2025-05': { pedro: 13, laura: 15 },
    '2025-06': { pedro: 16, laura: 25 },
    '2025-07': { pedro: 40, laura: 24 },
    '2025-08': { pedro: 26, laura: 19 },
    '2025-09': { pedro: 42, laura: 42 },
    '2025-10': { pedro: 15, laura: 22 },
    '2025-11': { pedro: 35, laura: 25 },
    '2025-12': { pedro: 35, laura: 27 },
    '2026-01': { pedro: 27, laura: 27 },
    '2026-02': { pedro: 23, laura: 15 },
    '2026-03': { pedro: 53, laura: 39 },
    '2026-04': { pedro: 60, laura: 51 },
    '2026-05': { pedro: 52, laura: 35 },
  },
  monthly_iniciacoes: {
    '2025-01': { pedro: 11, laura: 8 },
    '2025-02': { pedro: 22, laura: 28 },
    '2025-03': { pedro: 29, laura: 25 },
    '2025-04': { pedro: 24, laura: 21 },
    '2025-05': { pedro: 19, laura: 27 },
    '2025-06': { pedro: 31, laura: 29 },
    '2025-07': { pedro: 46, laura: 47 },
    '2025-08': { pedro: 46, laura: 47 },
    '2025-09': { pedro: 39, laura: 54 },
    '2025-10': { pedro: 54, laura: 51 },
    '2025-11': { pedro: 40, laura: 50 },
    '2025-12': { pedro: 47, laura: 53 },
    '2026-01': { pedro: 49, laura: 45 },
    '2026-02': { pedro: 44, laura: 47 },
    '2026-03': { pedro: 50, laura: 51 },
    '2026-04': { pedro: 40, laura: 39 },
    '2026-05': { pedro: 51, laura: 52 },
  },
  emojis: {
    pedro: ['❤', '😭', '🙏', '✨'],
    laura: ['😍', '🥰', '🤍', '😭', '✨'],
  ...
  jogo31_rounds: [
    ...
    },
    {
      ...
      resposta: 'Laura',
      decoy: 'Neymar',
      contexto: 'Segunda-feira depois de treino. Mesma energia do agachamento. Mas o Neymar provavelmente também fala isso toda hora...',
    },
    {
    ...
    quiz: [
      {
        ...
        correta: 'Laura',
        reveal: '239 dias vs 182. Ela acorda pensando nele.',
      },
      {
      ...
      },
      {
        ...
        opcoes: ['Pedro', 'Laura', 'Praticamente igual'],
        correta: 'Laura',
        reveal: "55 vezes vs 41. Ele: 'Sdd bonitinha'. Ela: 'saudades amor'. Dois jeitos de dizer a mesma coisa.",
      },
      {
  ...
  cap7: {
    dialogo: [
      ...
      { sender: 'claude', text: 'Tá bom, vou admitir. Você escreveu. Mas olha — em 30.525 mensagens ele disse isso pra você. Eu processei, organizei, analisei e não cheguei nem perto de entender o que significa de verdade. Essa parte é só sua.' },
    ],
...
export const FOOD_PHOTOS = [
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_2598_mwgmty.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_1678_btfgji.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3759_qybnxk.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3868_duw7hr.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_2185_qntmjz.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3947_aye0wt.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3891_szgayd.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_2311_jiucqm.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_1617_evtah2.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_9776_mxmjnw.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_9779_xxyrrs.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3929_g9gctv.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3214_dvvc32.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_2675_tw2zli.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3930_vebhdh.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_0114_s7tr2t.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_0110_mwfjgu.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3003_p9wsxe.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3736_zlztqy.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3609_btvowv.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3739_mg2kl8.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_0755_spfseh.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3977_yg98tk.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3892_ju0ujp.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_3812_gzw5xf.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_1343_g2ciga.jpg',
  'https://res.cloudinary.com/dhqowhiqr/image/upload/IMG_2659_sfllh7.jpg',
].map((v) => (v.startsWith('http') ? cdn(v) : v));

// Foto da Laura mordendo asinha (lado esquerdo da barrinha do franguinho):
// IMG_3929_g9gctv — índice 11 do array
export const LAURA_ASINHA_INDEX = 11;
